...
class EntryFields {
  static final List<String> values = [
    entryId, exerciseId, date, sets, maxWeight, totalVolume
  ];

  static final String entryId = '_entryId';
  static final String exerciseId = 'exerciseId';
  static final String date = 'date';
  static final String sets = 'sets';
  static final String maxWeight = 'maxWeight';
  static final String totalVolume = 'totalVolume';
}
